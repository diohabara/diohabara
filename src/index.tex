...
\lhead{
  ...
  , \href{https://scrapbox.io/jampon/}{Online Memo Link}
}
\usepackage{amsmath}
\usepackage{amssymb}
...
\section*{Projects}
  ...
  % \subsection*{Implementation of TCP/IP protocol with KLab: \textbf{by myself}}
  %   Implemented TCP/IP protocol in C with mentors and other participants as an internship project in B4.
  % \subsection*{Implementation of bookmark functionalities to Firefox: \textbf{in teams of 2}}
